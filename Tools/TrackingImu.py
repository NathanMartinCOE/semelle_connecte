...
def main(WheelchairIMU, startTime = 0, stopTime = 0):
    if stopTime == 0:
        stopTime = WheelchairIMU.time.shape[0]

    time = np.linspace(1, WheelchairIMU.time.shape[0], WheelchairIMU.time.shape[0])
    gyrX = WheelchairIMU.data["Gyro.X"]
    gyrY = WheelchairIMU.data["Gyro.Y"]
    gyrZ = WheelchairIMU.data["Gyro.Z"]
    accX = WheelchairIMU.data["Accel.X"]
    accY = WheelchairIMU.data["Accel.Y"]
    accZ = WheelchairIMU.data["Accel.Z"]
