# pytest -q --disable-pytest-warnings  TestMGait.py

# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Walking::test_Initialisation_Walking

# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Kinematics::test_GroundReactionForceKinematicsProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Kinematics::test_DynamicSymetryFunctionComputeProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Kinematics::test_TwoStepProcedure

# pytest -s --disable-pytest-warnings  TestMGait.py::Test_DataProcessing::test_NormalisationProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_DataProcessing::test_CutDataProcessingProcedure

# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Graphics::test_PlotMaxAndMinAsymetryProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Graphics::test_PlotWorthAndBestStepProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Graphics::test_PlotCutGroundReactionForceProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Graphics::test_PlotTwoStepProcedure
# pytest -s --disable-pytest-warnings  TestMGait.py::Test_Graphics::test_PlotDynamicSymetryFunctionNormalisedProcedure
